...
\emph{inverts} at $Q=32$ where V20 leads by 0.030 (robust, 5/6 scenes).
...
\cite{mimno2011coherence}. F-7 reports a normalised mutual information
\eqref{eq:f7}; the correction-for-chance and normalisation choices
follow \cite{vinh2010information}. F-18 instantiates the multi-seed
...
absolute values at $Q=32$ (F-2 0.910, F-7 0.563), and is the only
\emph{label-aware} recipe in the monotonic-improvement family.}
