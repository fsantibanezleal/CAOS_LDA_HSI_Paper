...
topic basis} of the sweep ($L_1 = 26.3$ vs $24.5$ for V12). Under
finer quantisation V20 keeps improving monotonically while V12 and
V3 saturate or regress, so V20 overtakes V12 as the LDA F-7 winner
at $Q=32$ (0.563 vs 0.533).
...
\caption{Q-sensitivity of the top contender recipes (V3, V8, V12,
V14, V18, V20) under LDA. Both F-2 $c_v$ and F-7 NMI plotted across
$Q \in \{8, 16, 32\}$. \textbf{V20 (purple, $\star$) is the only
recipe whose F-2 and F-7 means improve monotonically through Q=32};
V12 (orange) peaks at Q=16 and regresses; V3 (blue) saturates at
Q=8. \textbf{At Q=32 V20 overtakes V12 as the LDA F-7 winner
(0.563 vs 0.533).} V8 (green) is Q-insensitive because its
vocabulary equals the endmember count, independent of Q.}
