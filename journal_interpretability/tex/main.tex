...
V3/V12 (vocab ${\sim}1376$) score F-15 < 0.2 because the top-10 of a doc
...
(V9 = 1.0) which, with V20's $Q=32$ F-7 lead, argues against the
coherence advantage being a mere overfitting artefact.
...
the same concentration places its topics in the ultra-robust band
(F-22 sentinel-patched mean $=26.3$; a large fraction of its documents
never flip within 50 steps). This is consistent with P3's finding that
V20 leads F-7 at $Q=32$: a basis that concentrates discriminative mass
is simultaneously more coherent, harder to flip, and more attributable.
...
never flip within 50 steps) and a fragile regime (V9 $=1.0$),
complementing P3's coherence ranking by arguing against a
trivial-overfit account of V20's coherence lead. Third, and most important
