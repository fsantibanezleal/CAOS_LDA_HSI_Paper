...
\texttt{external\_validation/<scene>\_literature.json} artefacts ship
...
(\texttt{external\_validation/<subset>\_methods.json}). This axis is a
...
inverting the labelled-scene picture. The full 3895-artefact
