...
\section{Scope}
This supplement documents, per axis B-1 through B-12, the question
...
\section{B-1: Hierarchical Bayesian classification}
...
\section{B-2: Topic-word coherence}
...
\section{B-4: Capacity sensitivity}
...
\section{B-5: Band-mask robustness}
...
\section{B-6: Cross-method clustering agreement}
...
\section{B-7: Topic--label coupling}
...
mapping via Hungarian (a special case of B-8 applied to the label
...
\section{B-8: Per-topic identity tracking under masks}
...
\section{B-9: Preprocessing stability (HIDSAG)}
...
(basis-level, parallel to B-5's alternative); (b)~Recipe-conditioned
...
\section{B-10: Cross-scene topic transfer}
...
\section{B-11: Rate--distortion of $\theta$}
...
\section{B-12: External baseline comparison}
