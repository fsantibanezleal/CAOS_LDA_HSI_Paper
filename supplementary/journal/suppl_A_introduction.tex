...
\item \textbf{Twenty-plus axes.} We considered splitting F-3 into
inferential-stability + estimation-stability, F-5 into mask-set vs
band-budget, F-12 into intra-paper vs inter-paper baselines. Doing so
