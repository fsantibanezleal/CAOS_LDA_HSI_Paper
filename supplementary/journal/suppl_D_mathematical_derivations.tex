...
% Full mathematical derivations for each axis B-1 through B-12.
...
\section{Axis B-1: hierarchical Bayesian model}
...
\section{Axis B-2: coherence measures}
...
\section{Axis B-3: seed stability}
...
\section{Axis B-4: capacity sensitivity}
...
\section{Axis B-7: topic--label coupling}
...
\section{Axis B-8: per-topic Hungarian alignment}
Confusion matrix
...
\section{Axis B-9: HIDSAG preprocessing stability}
...
\section{Axis B-10: cross-scene transfer}
...
\section{Axis B-11: rate--distortion}
Reconstruct
...
\section{Axis B-12: external baseline}
...
\section{Inverse Hungarian (used in B-8 swap-rate computation)}
