...
framework axes B-6 (cross-method spatial agreement) and B-7
(spatial topic-label coupling on the H~$\times$~W raster) are
therefore not run on HIDSAG; axes B-1, B-2, B-3, B-4, B-5, B-8,
B-9, B-10, B-11, B-12 are all run, with B-5 using
