...
(axis F-3, journal Figure 4) are, to our knowledge, the first
...
$c_{\text{NPMI}}$, and U-Mass for axis F-2.
...
matching problem that the topic-id permutation step (axis F-8)
...
which we use as a cross-method-agreement baseline in axis F-6;
