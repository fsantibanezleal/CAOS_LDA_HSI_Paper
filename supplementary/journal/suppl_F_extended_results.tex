...
% Extended per-axis results: full tables for B-1..B-12 across 6 scenes
% + 5 HIDSAG subsets.
...
\section{Axis B-1: hierarchical Bayesian classification --- pairwise $P[A>B]$}
...
\section{Axis B-2: per-scene coherence}
...
\section{Axis B-3: seed stability per (scene, method)}
...
\section{Axis B-4: capacity sweep --- recommended $K$ per scene}
...
\section{Axis B-5: full paired ARI per (scene, mask)}
...
\section{Axis B-6: cross-method ARI per scene}
...
\section{Axis B-7: topic--label coupling per scene}
...
\section{Axis B-9: HIDSAG preprocessing stability per subset}
...
\section{Axis B-12: external baseline deltas}
