% ---------------------------------------------------------------------
% CAOS_LDA_HSI conference manuscript — preprint (target venue redacted)
%
...
%          name and submission date before actual submission.
% Length : 4-5 pages (full-paper track length budget)
% Class  : IEEEtran conference option (typesetting only — keeping the
...
companion code repository \cite{santibanezleal2022procemin}: each spectrum is
...
VNIR ($0.108$), no-water ($0.127$) and top-50 Fisher ($0.117$) it sits
